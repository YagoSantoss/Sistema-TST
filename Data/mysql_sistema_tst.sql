...
CREATE TABLE IF NOT EXISTS medicos (
    ...
    email VARCHAR(180),
    uf_expedidor VARCHAR(2),
    orgao_classe VARCHAR(120),
    sigla VARCHAR(40),
...
CREATE TABLE IF NOT EXISTS cats (
    ...
    aposentado TINYINT(1) NOT NULL DEFAULT 0,
    area VARCHAR(40),
    filiacao_prev_social VARCHAR(80),
    emitente VARCHAR(80),
    tipo_acidente VARCHAR(80),
    horas_trabalhadas_antes VARCHAR(20),
    houve_obito TINYINT(1) NOT NULL DEFAULT 0,
    data_obito DATE,
    houve_afastamento TINYINT(1) NOT NULL DEFAULT 0,
    registro_policia TINYINT(1) NOT NULL DEFAULT 0,
    ultimo_dia_trabalho DATE,
    codificacao_acidente VARCHAR(80),
    situacao_geradora VARCHAR(255),
    cat_emitida_por VARCHAR(120),
    local_acidente VARCHAR(180),
    especificacao_local VARCHAR(180),
    tipo_logradouro VARCHAR(60),
    numero VARCHAR(30),
    tipo_inscricao VARCHAR(30),
    inscricao_estabelecimento VARCHAR(40),
    logradouro VARCHAR(180),
